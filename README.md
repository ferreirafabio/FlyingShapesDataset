...
For instance, one can use it as a toy dataset to investigate the capacity and output behaviour of a deep neural network before testing it on real-world data. We have done this for a deep auto-encoder network:
